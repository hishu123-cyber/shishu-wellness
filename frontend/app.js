...
try{var todayData=null,diaryData=null;if(!isGuest){try{var results=await Promise.all([api('/diary/today'),api('/diary')]);todayData=todayData||{};diaryData=diaryData||[];}catch(e){}}var t=todayData||{};var list=diaryData||[];
